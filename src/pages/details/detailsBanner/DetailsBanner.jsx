...
const DetailsBanner = ({ video, crew }) => {
  ...
  //   extract gneres  through id only
            ...
            <React.Fragment>
              ...
              <ContentWrapper>
                <div className="content">
                  {/* to get poster img in left side  */}
                  <div className="left">
                    {data.poster_path ? (
                      <Img
                        className="posterImg"
                  ...
                  {/* to get all details in right side  */}
                  <div className="right">
                    {/* to get title with release_data */}
                    <div className="title">{`${data.name || data.title}(${dayjs(
                      data.release_date
                    ).format("YYYY")})`}</div>
                    {/* too get tagline of movie/tv  */}
                    ...
                    {/* //if there were a tv show than instead of director there was a created by  */}
                    {/* for writer  */}
